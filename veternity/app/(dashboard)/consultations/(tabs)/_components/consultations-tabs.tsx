...
const TABS = [
  { href: "/consultations/liste", label: "Consultations" },
  { href: "/consultations/prescriptions", label: "Prescriptions" },
  { href: "/consultations/historique", label: "Historique médicale" },
] as const;
...
export function ConsultationsTabs() {
  ...
  return (
    <nav className="grid grid-cols-3 divide-x divide-border border-b border-border">
      {TABS.map((tab) => {
